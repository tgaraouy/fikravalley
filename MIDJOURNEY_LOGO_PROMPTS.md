# 🎨 Midjourney Logo Prompts for Fikra Valley

## Brand Identity Summary

**Name:** Fikra Valley (Morocco's Valley of Ideas)  
**Tagline:** "Men l'Fikra l Machroû3" (From Idea to Project)  
**Core Value:** Voice-guided idea submission with 7 AI agents  
**Audience:** Moroccan entrepreneurs, diaspora, students  
**Colors:** Blue/Indigo (primary), Orange/Terracotta (accent), Green (success)  
**Style:** Modern, clean, professional, culturally authentic
...
### **Cultural Elements:**
- Moroccan tea pot (simplified, modern)
- Geometric patterns (subtle, not dominant)
- Valley shape (represents growth, journey)
- Flowing ideas (innovation, AI)
...
### **Tech Elements:**
- Data streams (representing AI agents)
- Light particles (ideas flowing)
- Circuit patterns (subtle, not dominant)
...
### **Dimensions:**
- **Primary Logo:** 16:9 or 3:1 (horizontal)
- **Icon:** 1:1 (square)
- **Favicon:** 1:1 (square, works at 16x16px)

### **Usage:**
- **Website Header:** Horizontal logo with text
- **Favicon:** Icon only (16x16, 32x32, 48x48)
- **Mobile:** Icon or compact horizontal
- **Social Media:** Square icon (1:1)
...
Use **Prompt 1 (Variation C)** - Symbol-focused
```
...
### **Step 2: Generate Wordmark**
Use **Prompt 1 (Variation B)** - Text-focused
```
...
### **Should Have:**
- ✅ Valley/mountain silhouette (represents "Valley")
- ✅ Flowing ideas (light particles, lines)
- ✅ Subtle Moroccan pattern (geometric)
- ✅ Clean typography

### **Nice to Have:**
- ✅ Tea pot element (cultural connection)
- ✅ AI/tech elements (circuit patterns, data streams)
- ✅ Gradient effect
- ✅ Animated version (for website)
...
```
Simplify the logo, remove unnecessary details, keep only essential elements, minimalist design, --style raw --v 6
```

### **If Logo Needs More Moroccan Identity:**
```
Add subtle Moroccan geometric patterns, integrate traditional tea pot element, maintain modern aesthetic, --style raw --v 6
```

### **If Logo Needs More Tech Feel:**
```
Add subtle circuit board patterns or data stream elements, maintain minimalist design, tech startup aesthetic, --style raw --v 6
```
...
- [ ] Works at 200x200px (social media)
